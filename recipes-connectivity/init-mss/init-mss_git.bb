...
do_install() {
    ...
    if ${@bb.utils.contains('DISTRO_FEATURES', 'systemd', 'true', 'false', d)}; then
        ...
        install -m 0644 ${WORKDIR}/init_mss.service -D ${D}${systemd_unitdir}/system/init_mss.service
        ln -sf ${systemd_unitdir}/system/init_mss.service \
            ${D}${systemd_unitdir}/system/multi-user.target.wants/init_mss.service
    else
