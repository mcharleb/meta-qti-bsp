...
PRIORITY = "optional"
PR = "r2"
DEPENDS_virtclass-native = "gettext-native gtk-doc-native pkgconfig-native"
DEPENDS = "glib-2.0-native gtk-doc zlib gettext-native gtk-doc-native \
                            pkgconfig-native"
...
do_configure_prepend () {
	...
	sed -i -e "s:libgio_2_0_la_LIBADD:libgio_2_0_la_CPPFLAGS = \$(ZLIB_CFLAGS) \$(AM_CPPFLAGS)\n\nlibgio_2_0_la_LIBADD:g"  ${S}/gio/Makefile.am
}
