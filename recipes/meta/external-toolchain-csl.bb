...
do_install() {
	...
	sed -e "s# /lib# ../../lib#g" -e "s# /usr/lib# .#g" ${D}${libdir}/${LEAD_SONAME} > ${D}${libdir}/temp
	mv ${D}${libdir}/temp ${D}${libdir}/${LEAD_SONAME}

	sed -e "s# /lib# ../../lib#" -e "s# /usr/lib# .#g" ${D}${libdir}/libpthread.so.0 > ${D}${libdir}/temp
	mv ${D}${libdir}/temp ${D}${libdir}/libpthread.so.0
}
